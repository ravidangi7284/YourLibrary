                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        <div className="p-6 mr-2 bg-gray-900 sm:rounded-lg">
                            ...
                            <div className="flex items-center mt-8 text-gray-200">
                                ...
                                <div className="ml-4 text-gray-200 text-md tracking-wide font-semibold w-40">
                                    Gaya Bihar
                                </div>
                            </div>
                            ...
                            <div className="flex items-center mt-2 text-gray-600">
                                ...
                                <div className="ml-4 text-md text-gray-200 tracking-wide font-semibold w-40">
                        ...
                        <form className="p-6 flex flex-col justify-center">
                            ...
                            <div className="flex flex-col mt-2">
                                <label for="tel" className="hidden text-gray-200">
                                    Number
                                </label>
                                <input
                                    type="tel"
